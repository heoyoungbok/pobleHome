...
<div class="animated bounceInDown">
    <div class="container">
        ...
        <form name="form1" class="box" action="/board/save" method="post" enctype="multipart/form-data">
            <h4><span>판매</span></h4>
            <h5>post</h5>
            <input id="boardWriter" name="boardWriter" placeholder="판매자" value="${sessionScope.loginID}" readonly>
<%--            <i class="typcn typcn-eye" id="eye"></i>--%>
            <input type="text" name="boardTitle" placeholder="제목">
            <textarea name="boardContents" placeholder="내용을 입력하세요" cols="50" rows="15" ></textarea>
            <input type="file" name="boardFile">
            <input type="text" name="boardTrade" id="boardTrade" placeholder="금액">

<%--            <label>--%>
<%--&lt;%&ndash;                <input type="checkbox">&ndash;%&gt;--%>
<%--                <span></span>--%>
<%--                &lt;%&ndash;                <small class="rmb">Remember me</small>&ndash;%&gt;--%>
<%--            </label>--%>
<%--            <a href="#" class="forgetpass">Forget Password?</a>--%>
            <input type="submit" value="Trade" class="btn1">
        </form>
