...
<div class="animated bounceInDown">
    <div class="container">
        ...
        <form name="form1" class="box" action="/save" method="post" enctype="multipart/form-data">
...
<script>
    ...
    const saveFn = () => {
        if (document.form1.memberLoginID.value == ""){
        ...
        return false;
    }else if (document.form1.memberPassword.value ==""){
            ...
            alert("이름을 입력해주세요");
            return false;
        }else if(document.form1.memberMobile.value == ""){
            alert("나이를 입력해주세요");
            return false;
        }else if(document.form1.memberAge.value == ""){
            alert("전화번호를 입력해주세요");
            return false;
        }
